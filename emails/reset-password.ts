export function buildResetEmail(code: string): string {
...
<head>
  ...
  <title>Zmiana hasła Lendigo</title>
</head>
          ...
          <tr>
            <td style="background:#ffffff;border-radius:28px;border:1px solid rgba(0,0,0,0.06);overflow:hidden;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background:linear-gradient(135deg,#0071e3 0%,#005bb5 100%);padding:32px 40px 28px;">
                    <p style="margin:0;font-size:11px;font-weight:600;color:rgba(255,255,255,0.7);text-transform:uppercase;letter-spacing:1.2px;">Zmiana hasła</p>
                    <h1 style="margin:8px 0 0;font-size:26px;font-weight:700;color:#ffffff;letter-spacing:-0.5px;line-height:1.2;">Zmień swoje hasło</h1>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td style="padding:36px 40px 8px;">
                    <p style="margin:0;font-size:15px;color:#1d1d1f;line-height:1.6;">
                      Otrzymaliśmy prośbę o zmianę hasła do Twojego konta Lendigo. Wpisz poniższy kod, aby ustawić nowe hasło.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:24px 40px 12px;">
                    <p style="margin:0;font-size:11px;font-weight:600;color:#6e6e73;text-transform:uppercase;letter-spacing:1px;">Twój kod do zmiany hasła</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:20px 40px 36px;">
                    <p style="margin:0;font-size:13px;color:#6e6e73;line-height:1.6;">
                      Jeśli nie prosiłeś/aś o zmianę hasła, możesz zignorować tę wiadomość. Twoje hasło pozostanie bez zmian.
                    </p>
                  </td>
                </tr>
